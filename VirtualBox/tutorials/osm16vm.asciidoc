...
* http://napoleon.hiperfit.dk/~niels/osm16-v1.1.ova
* http://harlem.dikurevy.dk/~niels/osm16-v1.1.ova
...
The SHA256 checksum of our `osm16-v1.1.ova` is:
...
Once you have a good-looking `osm16-v1.1.ova`, and have VirtualBox
installed:

. Open up VirtualBox and choose File → Import Appliance.
. Choose a virtual appliance to import: your `osm16-v1.1.ova`.
. Press "Next" and "Import".

You now have a virtual image "osm16-v1.0" in your left-hand sidebar (although
it's actually v1.1). Select it and press "Start".
